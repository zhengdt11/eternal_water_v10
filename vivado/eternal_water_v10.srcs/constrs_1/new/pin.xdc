...
#pull up
set_property PULLTYPE PULLUP [get_ports {emio_sccb_tri_io[0]}]
set_property PULLTYPE PULLUP [get_ports {emio_sccb_tri_io[1]}]
...
#pull up
set_property PULLTYPE PULLUP [get_ports {emio_sccb_tri_io[2]}]
set_property PULLTYPE PULLUP [get_ports {emio_sccb_tri_io[3]}]
#----------------------舵机控制信号---------------------------
...
set_property PACKAGE_PIN L16 [get_ports xsteer]
set_property PACKAGE_PIN U19 [get_ports ysteer]
set_property IOSTANDARD LVCMOS33 [get_ports xsteer]
set_property IOSTANDARD LVCMOS33 [get_ports ysteer]
set_property DRIVE 12 [get_ports ysteer]
