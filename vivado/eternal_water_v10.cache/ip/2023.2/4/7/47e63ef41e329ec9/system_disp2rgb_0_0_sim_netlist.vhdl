...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_disp_to_rgb is
  ...
  attribute SOFT_HLUTNM of \data_out[17]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \data_out[18]_i_1\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \data_out[22]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \data_out[23]_i_1\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \data_out[5]_i_1\ : label is "soft_lutpair3";
...
begin
  data_out(23 downto 18) <= \^data_out\(15 downto 10);
  data_out(17) <= \^data_out\(16);
  data_out(16 downto 10) <= \^data_out\(16 downto 10);
  data_out(9) <= \^data_out\(16);
  data_out(8) <= \^data_out\(16);
  data_out(7 downto 2) <= \^data_out\(7 downto 2);
  data_out(1) <= \^data_out\(0);
  data_out(0) <= \^data_out\(0);
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_disp_to_rgb
     port map (
      clk => clk,
      data_in(6 downto 0) => data_in(6 downto 0),
      data_out(13 downto 8) => \^data_out\(15 downto 10),
      data_out(7) => \^data_out\(16),
      data_out(6 downto 1) => \^data_out\(7 downto 2),
      data_out(0) => \^data_out\(0),
