...
static const VideoMode VMODE_1280x480 = {
    .label = "1280x480@60Hz",
    .width = 1280,
    .height = 480,
    .hps = 1344,        // Start of HSync pulse (active width + H front porch)
    .hpe = 1394,        // End of HSync pulse (active width + H front porch + H sync width)
    .hmax = 1650,       // Total pixels per line (active width + H front porch + H sync width + H back porch)
    .hpol = 1,          // HSync polarity
    .vps = 490,         // Start of VSync pulse (active height + V front porch)
    .vpe = 492,         // End of VSync pulse (active height + V front porch + V sync width)
    .vmax = 525,        // Total lines per frame (active height + V front porch + V sync width + V back porch)
    .vpol = 1,          // VSync polarity
    .freq = 60.0        // Pixel Clock frequency for 60Hz refresh rate
};
